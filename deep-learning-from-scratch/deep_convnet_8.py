...
class DeepConvNet:
    ...
    def __init__(self, input_dim=(1, 28, 28),
        ...
        weight_init_scales = np.sqrt(2 / pre_node_num)
        ...
        for idx, conv_param in enumerate([conv_param_1, conv_param_2, conv_param_3, conv_param_4,
            ...
            self.params['W' + str(idx+1)] = \
                    weight_init_scales[idx] * np.random.randn(conv_param['filter_num'],
                                                            pre_channel_num,
